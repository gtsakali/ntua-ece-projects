.data
x: .word 10, 15, 5, 8, 20  # Array x
y: .word 7, 12, 4, 11, 9   # Array y
n: .word 5                 # Length of arrays

.text
.globl main
main:
    la $a0, x              # Load address of array x into $a0
    la $a1, y              # Load address of array y into $a1
    lw $a2, n              # Load array size into $a2

    jal find_min_sum       # Call your function
